...
const StartSection = () => {
    return (
        <div className="flex md:justify-between w-full " >
            <div className="text-[15px] md:text-[20px] absolute md:sticky top-[-80px] max-w-[60%] font-semibold text-[#A6A3A3]" >Here you can track all of your key stats and access key features.</div>
